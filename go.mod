...
require (
	...
	github.com/stolostron/go-template-utils v1.3.2-0.20220107144059-2948b650f6c5
	k8s.io/api v0.21.3
	k8s.io/apimachinery v0.21.3
	k8s.io/client-go v12.0.0+incompatible
	k8s.io/klog v1.0.0
	open-cluster-management.io/api v0.5.1-0.20220107041310-9303b90b6ade
	open-cluster-management.io/multicloud-operators-subscription v0.5.1-0.20220107223414-8e02279deaa5
