...
func (in *PolicySetStatusResult) DeepCopyInto(out *PolicySetStatusResult) {
	*out = *in
	if in.CompliantClusters != nil {
		in, out := &in.CompliantClusters, &out.CompliantClusters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.NonCompliantClusters != nil {
		in, out := &in.NonCompliantClusters, &out.NonCompliantClusters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
