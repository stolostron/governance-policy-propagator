...
require (
	...
	github.com/stolostron/go-template-utils/v4 v4.3.1-0.20240815173643-377547f8ba0c
...
replace open-cluster-management.io/multicloud-operators-subscription => github.com/stolostron/multicloud-operators-subscription v1.2.4-0-20211122-7277a37.0.20240523030503-8db21b6fcbe9
