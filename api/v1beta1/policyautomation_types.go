...
type AutomationDef struct {
	...
	ExtraVars *runtime.RawExtension `json:"extra_vars,omitempty"` //nolint:tagliatelle // API contract
...
type ReplicatedPolicyStatus struct {
	...
	ViolationMessage string                         `json:"violation_message"` //nolint:tagliatelle // API contract
