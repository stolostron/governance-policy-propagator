...
const (
	...
	case10PolicySetYaml       string = "../resources/case10_policyset_propagation/case10-test-policyset.yaml"
	case10PolicySetPolicyYaml string = "../resources/case10_policyset_propagation/case10-test-policyset-policy.yaml"
)
